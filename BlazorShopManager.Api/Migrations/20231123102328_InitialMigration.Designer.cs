...
namespace BlazorShopManager.Api.Migrations
{
    ...
    [Migration("20231123102328_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorShopManager.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("BlazorShopManager.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("BlazorShopManager.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShopManager.Shared.Domain.Employee", b =>
                {
                    b.HasOne("BlazorShopManager.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorShopManager.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
